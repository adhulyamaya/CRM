...
const DigiContextProvider = ({ children }) => {
  ...
  const handleLightThemeToggle = () => {
    setThemeSelection({ default: false, dark: false, light: true });
    bodyElement.classList.add("light-theme");
    bodyElement.classList.remove("dark-theme");
  };
  ...
  const handleDarkThemeToggle = () => {
    setThemeSelection({ default: false, dark: true, light: false });
    bodyElement.classList.add("dark-theme");
    bodyElement.classList.remove("light-theme");
  };
...
// Modify toggleAccountsDropdown function
  const toggleAccountsDropdown = () => {
    setState((prevState) => ({
      ...prevState,
      isAccountsDropdownOpen: !prevState.isAccountsDropdownOpen,
      isCrmDropdownOpen: false,
      isHrmDropdownOpen: false,
      isEcommerceDropdownOpen: false,
